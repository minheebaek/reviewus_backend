...
public interface BoardService {
    ResponseEntity<? super GetNoOffsetResponseDto> findUserIdAndBoardByCreatedAtDesc(Long auctionId, Pageable pageable, String searchWord, LoginUserDto loginUserDto);
